...
export const COUPLINGS = {
    a: {
        ...
        description: 'products.industrialCouplings.line_a.description',
    ...
    an: {
        ...
        description: 'products.industrialCouplings.line_an.description',
        power: 'products.industrialCouplings.line_an.power',
        sizes: 'products.industrialCouplings.line_an.sizes',
        useCases: 'products.industrialCouplings.line_an.useCases',
    },
    br: {
        route: '/products/a/br',
        image: LineaBr,
        ...
        description: 'products.industrialCouplings.line_br.description',
    ...
    ez: {
        ...
        description: 'products.industrialCouplings.line_ez.description',
        power: 'products.industrialCouplings.line_ez.power',
    ...
    spiroflex: {
        ...
        description: 'products.industrialCouplings.line_spiroflex.description',
        power: 'products.industrialCouplings.spiroflex.power',
...
export const PNEUMATIC_BRAKS = {
    fk: {
        ...
        description: 'products.pneumaticBrake.fk.description',
        power: 'products.pneumaticBrake.fk.power',
        sizes: 'products.pneumaticBrake.fk.sizes',
        useCases: 'products.pneumaticBrake.fk.useCases',
    },
    fke: {
        ...
        description: 'products.pneumaticBrake.fke.description',
        power: 'products.pneumaticBrake.fke.power',
        sizes: 'products.pneumaticBrake.fke.sizes',
        useCases: 'products.pneumaticBrake.fke.useCases',
    },
    fkr: {
        ...
        description: 'products.pneumaticBrake.fkr.description',
        power: 'products.pneumaticBrake.fkr.power',
        sizes: 'products.pneumaticBrake.fkr.sizes',
        useCases: 'products.pneumaticBrake.fkr.useCases',
    },
    fkt: {
        ...
        description: 'products.pneumaticBrake.fkt.description',
    ...
    fm: {
        route: '/products/b/fm',
        image: LineaFm,
        label: 'products.pneumaticBrake.fm.name',
        general: 'products.pneumaticBrake.fm.general',
        description: 'products.pneumaticBrake.fm.description',
        power: 'products.pneumaticBrake.fm.power',
        sizes: 'products.pneumaticBrake.fm.sizes',
        useCases: 'products.pneumaticBrake.fm.useCases',
    },
    rn: {
        route: '/products/b/rn',
        image: LineaRn,
        label: 'products.pneumaticBrake.rn.name',
        general: 'products.pneumaticBrake.rn.general',
        description: 'products.pneumaticBrake.rn.description',
        power: 'products.pneumaticBrake.rn.power',
        sizes: 'products.pneumaticBrake.rn.sizes',
        useCases: 'products.pneumaticBrake.rn.useCases',
    },
}
export const PNEUMATIC_CAMERAS = {
    cn: {
        ...
        description: 'products.pneumaticCameras.cn.description',
        power: 'products.pneumaticCameras.cn.power',
